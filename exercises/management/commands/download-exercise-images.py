...
class Command(BaseCommand):
    '''
    Download exercise images from de and updates the local database
    ...
    option_list = BaseCommand.option_list + (
        make_option('--remote-url',
                    ...
                    dest='remote_url',
                    default='https://de',
                    help='Remote URL to fetch the exercises from (default: https://de)'),
        )

    help = ('Download exercise images from de and update the local database\n'
            '\n'
