...
from exercises.views import comments
from exercises.views import categories
from exercises.views import muscles
from exercises.views import images
from exercises.views import equipment
...
urlpatterns = patterns('exercises.views',
    ...
    url(r'^image/(?P<pk>\d+)/accept/$',
        images.accept,
        name='exerciseimage-accept'),
    url(r'^image/(?P<pk>\d+)/decline/$',
        images.decline,
        name='exerciseimage-decline'),
