...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.video_type'
        db.alter_column(u'video_video', 'video_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['video.VideoType'], null=True))

    def backwards(self, orm):

        # Changing field 'Video.video_type'
        db.alter_column(u'video_video', 'video_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['video.VideoType']))
    ...
    models = {
        ...
        u'video.video': {
            ...
            'video_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['video.VideoType']", 'null': 'True', 'blank': 'True'})
        },
        u'video.videoreply': {
