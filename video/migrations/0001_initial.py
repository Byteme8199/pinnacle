...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'video_videotype', (
        ...
        db.send_create_signal(u'video', ['VideoType'])
        ...
        db.create_table(u'video_video', (
            ...
            ('has_compressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('video_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['video.VideoType'])),
            ('thumbnail_holder', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'video', ['Video'])

        # Adding model 'VideoReply'
        db.create_table(u'video_videoreply', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['video.Video'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 23, 0, 0))),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('video_embed', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('has_compressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'video', ['VideoReply'])


    def backwards(self, orm):
        # Deleting model 'VideoType'
        db.delete_table(u'video_videotype')

        # Deleting model 'Video'
        db.delete_table(u'video_video')

        # Deleting model 'VideoReply'
        db.delete_table(u'video_videoreply')
