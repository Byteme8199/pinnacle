...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkoutWeek.weight'
        db.alter_column(u'workoutsheet_workoutweek', 'weight', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WorkoutWeek.reps'
        db.alter_column(u'workoutsheet_workoutweek', 'reps', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'WorkoutWeek.weight'
        db.alter_column(u'workoutsheet_workoutweek', 'weight', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=4, null=True))

        # Changing field 'WorkoutWeek.reps'
        db.alter_column(u'workoutsheet_workoutweek', 'reps', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=4, null=True))
    ...
    models = {
        ...
        u'workoutsheet.workoutsheet': {
            'Meta': {'ordering': "['-start_date']", 'object_name': 'WorkoutSheet'},
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'workout_template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workout_template.WorkoutSheetTemplate']", 'null': 'True', 'blank': 'True'})
        },
