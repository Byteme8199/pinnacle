...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkoutSheet.workout_template'
        db.add_column(u'workoutsheet_workoutsheet', 'workout_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workout_template.WorkoutSheetTemplate'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkoutSheet.workout_template'
        db.delete_column(u'workoutsheet_workoutsheet', 'workout_template_id')
