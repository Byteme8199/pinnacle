...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkoutSheet.start_date'
        db.add_column(u'workoutsheet_workoutsheet', 'start_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 11, 2, 0, 0), null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkoutSheet.start_date'
        db.delete_column(u'workoutsheet_workoutsheet', 'start_date')
    ...
    models = {
        u'account.account': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 2, 0, 0)'}),
        ...
        u'workoutsheet.workoutsheet': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 2, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
