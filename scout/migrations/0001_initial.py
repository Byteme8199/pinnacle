...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scout_criterion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'scout', ['Criterion'])

        # Adding model 'CriterionRank'
        db.create_table(u'scout_criterionrank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('criterion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scout.Criterion'])),
            ('scoutsheet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scout.ScoutSheet'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'])),
        ))
        db.send_create_signal(u'scout', ['CriterionRank'])

        # Adding model 'ScoutSheet'
        db.create_table(u'scout_scoutsheet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 23, 0, 0))),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'scout', ['ScoutSheet'])


    def backwards(self, orm):
        # Deleting model 'Criterion'
        db.delete_table(u'scout_criterion')

        # Deleting model 'CriterionRank'
        db.delete_table(u'scout_criterionrank')

        # Deleting model 'ScoutSheet'
        db.delete_table(u'scout_scoutsheet')
