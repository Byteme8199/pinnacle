...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CriterionScaleRow.scale'
        db.add_column(u'scout_criterionscalerow', 'scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['scout.CriterionScale']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CriterionScaleRow.scale'
        db.delete_column(u'scout_criterionscalerow', 'scale_id')
