...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CriterionScale.row_info'
        db.delete_column(u'scout_criterionscale', 'row_info_id')

        # Adding field 'CriterionScale.column_one_name'
        db.add_column(u'scout_criterionscale', 'column_one_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'CriterionScale.column_two_name'
        db.add_column(u'scout_criterionscale', 'column_two_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CriterionScale.row_info'
        db.add_column(u'scout_criterionscale', 'row_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['scout.CriterionScaleRow']),
                      keep_default=False)

        # Deleting field 'CriterionScale.column_one_name'
        db.delete_column(u'scout_criterionscale', 'column_one_name')

        # Deleting field 'CriterionScale.column_two_name'
        db.delete_column(u'scout_criterionscale', 'column_two_name')
    ...
    models = {
        ...
        u'scout.criterionscale': {
            ...
            'column_two_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
