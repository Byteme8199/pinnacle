...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoutSheet.ratings_arm_strength_f'
        db.add_column(u'scout_scoutsheet', 'ratings_arm_strength_f',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScoutSheet.ratings_arm_accuracy_p'
        db.add_column(u'scout_scoutsheet', 'ratings_arm_accuracy_p',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScoutSheet.makeup_aggressiveness'
        db.add_column(u'scout_scoutsheet', 'makeup_aggressiveness',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ScoutSheet.ratings_arm_strength_f'
        db.delete_column(u'scout_scoutsheet', 'ratings_arm_strength_f')

        # Deleting field 'ScoutSheet.ratings_arm_accuracy_p'
        db.delete_column(u'scout_scoutsheet', 'ratings_arm_accuracy_p')

        # Deleting field 'ScoutSheet.makeup_aggressiveness'
        db.delete_column(u'scout_scoutsheet', 'makeup_aggressiveness')
