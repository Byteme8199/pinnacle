...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CriterionRank.account'
        db.delete_column(u'scout_criterionrank', 'account_id')

        # Deleting field 'CriterionRank.criterion'
        db.delete_column(u'scout_criterionrank', 'criterion_id')


    def backwards(self, orm):
        # Adding field 'CriterionRank.account'
        db.add_column(u'scout_criterionrank', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['account.Account']),
                      keep_default=False)

        # Adding field 'CriterionRank.criterion'
        db.add_column(u'scout_criterionrank', 'criterion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['scout.Criterion']),
                      keep_default=False)
