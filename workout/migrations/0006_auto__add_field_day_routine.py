...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Day.routine'
        db.add_column(u'workout_day', 'routine',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['workout.Routine']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Day.routine'
        db.delete_column(u'workout_day', 'routine_id')
