...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExerciseSet.instructions'
        db.alter_column(u'workout_exerciseset', 'instructions', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ExerciseType.description'
        db.alter_column(u'workout_exercisetype', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ExerciseType.hints'
        db.alter_column(u'workout_exercisetype', 'hints', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Day.has_completed'
        db.add_column(u'workout_day', 'has_completed',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ExerciseSet.instructions'
        db.alter_column(u'workout_exerciseset', 'instructions', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ExerciseType.description'
        db.alter_column(u'workout_exercisetype', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ExerciseType.hints'
        db.alter_column(u'workout_exercisetype', 'hints', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
        # Deleting field 'Day.has_completed'
        db.delete_column(u'workout_day', 'has_completed')
