...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Routine.created_date'
        db.add_column(u'workout_routine', 'created_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 10, 3, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Routine.created_date'
        db.delete_column(u'workout_routine', 'created_date')
