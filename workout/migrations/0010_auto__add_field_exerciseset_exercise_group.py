...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseSet.exercise_group'
        db.add_column(u'workout_exerciseset', 'exercise_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['workout.ExerciseSetGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseSet.exercise_group'
        db.delete_column(u'workout_exerciseset', 'exercise_group_id')
