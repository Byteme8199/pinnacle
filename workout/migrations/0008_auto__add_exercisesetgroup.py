...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExerciseSetGroup'
        db.create_table(u'workout_exercisesetgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'workout', ['ExerciseSetGroup'])

        # Adding M2M table for field exercise_sets on 'ExerciseSetGroup'
        db.create_table(u'workout_exercisesetgroup_exercise_sets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('exercisesetgroup', models.ForeignKey(orm[u'workout.exercisesetgroup'], null=False)),
            ('exerciseset', models.ForeignKey(orm[u'workout.exerciseset'], null=False))
        ))
        db.create_unique(u'workout_exercisesetgroup_exercise_sets', ['exercisesetgroup_id', 'exerciseset_id'])


    def backwards(self, orm):
        # Deleting model 'ExerciseSetGroup'
        db.delete_table(u'workout_exercisesetgroup')

        # Removing M2M table for field exercise_sets on 'ExerciseSetGroup'
        db.delete_table('workout_exercisesetgroup_exercise_sets')
    ...
    models = {
        ...
        u'workout.day': {
            ...
            'exercise_set': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workout.ExerciseSet']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
