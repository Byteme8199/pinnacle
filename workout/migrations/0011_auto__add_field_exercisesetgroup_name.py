...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseSetGroup.name'
        db.add_column(u'workout_exercisesetgroup', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseSetGroup.name'
        db.delete_column(u'workout_exercisesetgroup', 'name')
