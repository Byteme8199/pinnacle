...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Day.exercise_set'
        db.delete_column(u'workout_day', 'exercise_set_id')

        # Adding field 'Day.exercise_group'
        db.add_column(u'workout_day', 'exercise_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['workout.ExerciseSetGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Day.exercise_set'
        db.add_column(u'workout_day', 'exercise_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['workout.ExerciseSet']),
                      keep_default=False)

        # Deleting field 'Day.exercise_group'
        db.delete_column(u'workout_day', 'exercise_group_id')
