...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Routine.description'
        db.add_column(u'workout_routine', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Routine.description'
        db.delete_column(u'workout_routine', 'description')
