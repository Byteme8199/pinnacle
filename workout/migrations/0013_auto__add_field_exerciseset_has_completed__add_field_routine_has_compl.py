...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseSet.has_completed'
        db.add_column(u'workout_exerciseset', 'has_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Routine.has_completed'
        db.add_column(u'workout_routine', 'has_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseSet.has_completed'
        db.delete_column(u'workout_exerciseset', 'has_completed')

        # Deleting field 'Routine.has_completed'
        db.delete_column(u'workout_routine', 'has_completed')
    ...
    models = {
        ...
        u'workout.routine': {
            ...
            'created_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 3, 0, 0)'}),
