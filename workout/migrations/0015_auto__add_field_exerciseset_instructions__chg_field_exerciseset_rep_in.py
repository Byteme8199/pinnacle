...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseSet.instructions'
        db.add_column(u'workout_exerciseset', 'instructions',
                      self.gf('django.db.models.fields.CharField')(default='instructions here', max_length=255),
                      keep_default=False)


        # Changing field 'ExerciseSet.rep_info'
        db.alter_column(u'workout_exerciseset', 'rep_info', self.gf('django.db.models.fields.CharField')(max_length=120))
        # Adding field 'ExerciseType.description'
        db.add_column(u'workout_exercisetype', 'description',
                      self.gf('django.db.models.fields.CharField')(default='description here', max_length=255),
                      keep_default=False)

        # Adding field 'ExerciseType.hints'
        db.add_column(u'workout_exercisetype', 'hints',
                      self.gf('django.db.models.fields.CharField')(default='hints here', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseSet.instructions'
        db.delete_column(u'workout_exerciseset', 'instructions')


        # Changing field 'ExerciseSet.rep_info'
        db.alter_column(u'workout_exerciseset', 'rep_info', self.gf('django.db.models.fields.CharField')(max_length=80))
        # Deleting field 'ExerciseType.description'
        db.delete_column(u'workout_exercisetype', 'description')

        # Deleting field 'ExerciseType.hints'
        db.delete_column(u'workout_exercisetype', 'hints')
    ...
    models = {
        ...
        u'workout.exercisetype': {
            ...
            'hints': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'workout.routine': {
