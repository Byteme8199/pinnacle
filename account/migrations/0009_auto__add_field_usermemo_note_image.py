...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMemo.note_image'
        db.add_column(u'account_usermemo', 'note_image',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMemo.note_image'
        db.delete_column(u'account_usermemo', 'note_image')
