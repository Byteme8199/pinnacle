...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.dob'
        db.add_column(u'account_account', 'dob',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Account.profile_image'
        db.alter_column(u'account_account', 'profile_image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Account.grad_year'
        db.alter_column(u'account_account', 'grad_year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'Account.dob'
        db.delete_column(u'account_account', 'dob')


        # Changing field 'Account.profile_image'
        db.alter_column(u'account_account', 'profile_image', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))

        # Changing field 'Account.grad_year'
        db.alter_column(u'account_account', 'grad_year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True))
