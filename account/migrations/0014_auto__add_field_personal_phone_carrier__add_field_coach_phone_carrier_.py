...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Personal.phone_carrier'
        db.add_column(u'account_personal', 'phone_carrier',
                      self.gf('django.db.models.fields.CharField')(default='ATT', max_length=100),
                      keep_default=False)

        # Adding field 'Coach.phone_carrier'
        db.add_column(u'account_coach', 'phone_carrier',
                      self.gf('django.db.models.fields.CharField')(default='ATT', max_length=100),
                      keep_default=False)

        # Adding field 'Parent.phone_carrier'
        db.add_column(u'account_parent', 'phone_carrier',
                      self.gf('django.db.models.fields.CharField')(default='ATT', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Personal.phone_carrier'
        db.delete_column(u'account_personal', 'phone_carrier')

        # Deleting field 'Coach.phone_carrier'
        db.delete_column(u'account_coach', 'phone_carrier')

        # Deleting field 'Parent.phone_carrier'
        db.delete_column(u'account_parent', 'phone_carrier')
    ...
    models = {
        u'account.account': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 31, 0, 0)'}),
        ...
        u'account.coach': {
            ...
            'phone_carrier': ('django.db.models.fields.CharField', [], {'default': "'ATT'", 'max_length': '100'}),
