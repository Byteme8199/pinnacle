...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Personal.facebook'
        db.add_column(u'account_personal', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personal.twitter'
        db.add_column(u'account_personal', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personal.instagram'
        db.add_column(u'account_personal', 'instagram',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coach.facebook'
        db.add_column(u'account_coach', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coach.twitter'
        db.add_column(u'account_coach', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coach.instagram'
        db.add_column(u'account_coach', 'instagram',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parent.facebook'
        db.add_column(u'account_parent', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parent.twitter'
        db.add_column(u'account_parent', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parent.instagram'
        db.add_column(u'account_parent', 'instagram',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Personal.facebook'
        db.delete_column(u'account_personal', 'facebook')

        # Deleting field 'Personal.twitter'
        db.delete_column(u'account_personal', 'twitter')

        # Deleting field 'Personal.instagram'
        db.delete_column(u'account_personal', 'instagram')

        # Deleting field 'Coach.facebook'
        db.delete_column(u'account_coach', 'facebook')

        # Deleting field 'Coach.twitter'
        db.delete_column(u'account_coach', 'twitter')

        # Deleting field 'Coach.instagram'
        db.delete_column(u'account_coach', 'instagram')

        # Deleting field 'Parent.facebook'
        db.delete_column(u'account_parent', 'facebook')

        # Deleting field 'Parent.twitter'
        db.delete_column(u'account_parent', 'twitter')

        # Deleting field 'Parent.instagram'
        db.delete_column(u'account_parent', 'instagram')
