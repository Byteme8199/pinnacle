...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'CarouselImage.account'
        db.delete_column(u'account_carouselimage', 'account_id')
    ...
    models = {
        u'account.account': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 21, 0, 0)'}),
