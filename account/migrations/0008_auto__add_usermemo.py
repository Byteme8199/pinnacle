...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserMemo'
        db.create_table(u'account_usermemo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'])),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 7, 0, 0))),
        ))
        db.send_create_signal(u'account', ['UserMemo'])


    def backwards(self, orm):
        # Deleting model 'UserMemo'
        db.delete_table(u'account_usermemo')
    ...
    models = {
        u'account.account': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 7, 0, 0)'}),
