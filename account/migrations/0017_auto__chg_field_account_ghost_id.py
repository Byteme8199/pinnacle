...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.ghost_id'
        db.alter_column(u'account_account', 'ghost_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'], null=True))

    def backwards(self, orm):

        # Changing field 'Account.ghost_id'
        db.alter_column(u'account_account', 'ghost_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['account.Account']))
    ...
    models = {
        u'account.account': {
            ...
            'ghost_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.Account']", 'null': 'True', 'blank': 'True'}),
