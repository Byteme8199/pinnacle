...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.club'
        db.add_column(u'account_account', 'club',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.throws'
        db.add_column(u'account_account', 'throws',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.bats'
        db.add_column(u'account_account', 'bats',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.grad_class'
        db.add_column(u'account_account', 'grad_class',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.eligible'
        db.add_column(u'account_account', 'eligible',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.club'
        db.delete_column(u'account_account', 'club')

        # Deleting field 'Account.throws'
        db.delete_column(u'account_account', 'throws')

        # Deleting field 'Account.bats'
        db.delete_column(u'account_account', 'bats')

        # Deleting field 'Account.grad_class'
        db.delete_column(u'account_account', 'grad_class')

        # Deleting field 'Account.eligible'
        db.delete_column(u'account_account', 'eligible')
    ...
    models = {
        u'account.account': {
            ...
            'dob': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
