...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.team_image'
        db.add_column(u'account_account', 'team_image',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.team_image'
        db.delete_column(u'account_account', 'team_image')
