...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.dob'
        db.alter_column(u'account_account', 'dob', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Account.dob'
        db.alter_column(u'account_account', 'dob', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True))
